function [err, rels] = get_error_est(res, M, rhs, method, disconts)
    ...
    displayErrors(rels, M, method.err_treshold, method.err_priority_treshold, method.save_plots || method.save_every_iteration || ismember(k, method.plot_iterations), method.plot_name, method);
